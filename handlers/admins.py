...
async def pause(client: Client, message: Message):
    ...
    await message.reply_text("〰️GoodVibes〰️=⏸ Durduruldu.")
...
async def resume(client: Client, message: Message):
    ...
    await message.reply_text("〰️GoodVibes〰️=▶️ Devam.")
...
async def stop(client: Client, message: Message):
    ...
    await message.reply_text("〰️GoodVibes〰️=⏹ Akışı durdurdum.")
...
async def skip(client: Client, message: Message):
    ...
    if sira.is_empty(chat_id):
        ...
        await message.reply_text("〰️GoodVibes〰️=⏩ Geçerli şarkı atlandı.")
...
async def admincache(client, message: Message):
    ...
    await message.reply_text("〰️GoodVibes〰️=❇️ Yönetici önbelleği yenilendi!")
